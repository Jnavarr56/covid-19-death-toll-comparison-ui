        ...
        <div className={classes.root}>
          <div className={classes.contentContainer}>
            ...
            <Typography variant="body1" gutterBottom={true}>
              ...
              and was about to apply but was worried that since I've been
              working with Node.js recently instead of Ruby (current project is
              a Node.js microservices based API), that the lack of a current
              Rails project would hurt my application. I'd been thinking about
              doing something with Covid-19 data so I quickly wrote a Ruby
              script to aggregate some death counts and then translated the
              functionality into an Ruby on Rails API application. I then build
              this simple React UI to pull data from that API.
              <br />
              <br />
